...
namespace ProBuilder2.Examples
{
	...
	public class RuntimeEdit : MonoBehaviour
	{
		...
		public void LateUpdate()
		{
			...
			if(UnityEngine.Input.GetMouseButtonDown(1) || (UnityEngine.Input.GetMouseButtonDown(0) && UnityEngine.Input.GetKey(KeyCode.LeftAlt)))
			{
                mousePosition_initial = UnityEngine.Input.mousePosition;
                dragging = true;
			}

			if(dragging)
			{
                Vector2 delta = (Vector3)mousePosition_initial - (Vector3)UnityEngine.Input.mousePosition;
			...
			if(UnityEngine.Input.GetMouseButtonUp(1) || UnityEngine.Input.GetMouseButtonUp(0))
			{
                dragging = false;
			}
		}
		...
		public void Update()
		{
			if(UnityEngine.Input.GetMouseButtonUp(0) && !UnityEngine.Input.GetKey(KeyCode.LeftAlt)) {

				if(FaceCheck(UnityEngine.Input.mousePosition))
				{
					if(currentSelection.IsValid())
					{
